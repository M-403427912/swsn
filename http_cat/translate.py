...
def build_url(text, tk, tl='zh-CN'):
    ...
    :return:
    """
    return 'https://translate.googleapis.com/translate_a/single?client=webapp&sl=auto&tl=' + tl + '&hl=zh-CN&dt=at&dt=bd&dt=ex&dt=ld&dt=md&dt=qca&dt=rw&dt=rm&dt=ss&dt=t&source=btn&ssel=0&tsel=0&kc=0&tk=' \
...
if __name__ == '__main__':
    debug = False
    translate_text = 'に関する記事をご紹介しています。'
